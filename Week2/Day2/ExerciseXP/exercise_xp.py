...
bengal_obj = Bengal("Roger", 10)
chartreux_obj = Chartreux("Mitzi", 5)
siamese_obj = Siamese("Hatul", 2)
...
class Dog:
    ...
    def fight(self, other_dog):
        ...
        return f"{winning_dog.name} won the fight!"


dog1 = Dog("Kiara", 1, 6.6)
dog2 = Dog("Pulga", 5, 7.2)
dog3 = Dog("Bounty", 4, 4.2)
